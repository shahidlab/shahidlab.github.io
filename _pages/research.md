...
![Diagram of interspecies RNA interference between Cuscuta and its host plant]({{ site.url }}{{ site.baseurl }}/assets/images/interspecies_RNAi.png){: .align-center}
