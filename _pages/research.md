...
#classes: wide
title: Research
description: Research from the Shahid Lab at the University of Sheffield investigating mobile RNA, epigenetic regulation and plant-parasite interactions.
header:
  #overlay_color: "#111"
...
The Shahid lab investigates how regulatory RNAs, epigenetic processes, and genome plasticity shape intimate interactions between plants and other organisms, and how these interactions, in turn, drive genome evolution. Using parasitic plants as powerful models, we ask how small RNAs move between species, whether these encounters leave an epigenetic memory, and how genome plasticity enables the evolution of parasitism.
...
<nav class="join-nav" markdown="0">
  <a href="#interspecies" class="btn btn--brand-yellow">Interspecies RNAi</a>
  <a href="#memory" class="btn btn--brand-teal">Epigenetic memory</a>
  <a href="#plasticity" class="btn btn--brand-blue">Genome plasticity in plant parasitism</a>
</nav>
...
## Genome plasticity in plant parasitism
{: #plasticity}
![Cuscuta parasitizing Arabidopsis]({{ site.url }}{{ site.baseurl }}/assets/images/dodder-seedling.jpg){: .align-right}{:width="400"}
...
Our previous work showed that horizontally acquired loci in *Cuscuta* are frequent sources of 24-nucleotide small RNAs and that at least one transferred locus overlaps an interspecies regulatory microRNA known to regulate host gene expression [(Yang et al., 2019, Nature Plants)](https://doi.org/10.1038/s41477-019-0458-0). This raises the intriguing possibility that some of the foreign/invasive sequences initially subjected to genome surveillance can eventually be repurposed for interspecies regulation. Using some of the highly invasive parasitic weeds *Cuscuta* and *Striga*, we investigate how foreign DNA is recognised, epigenetically regulated and repurposed, and whether these processes contribute to epigenomic plasticity, adaptation and the evolution of parasitism. As part of this project, we are collaborating with the laboratories of [Michael Timko](https://bio.as.virginia.edu/people/mpt9g) (University of Virginia) and [Claude dePamphilis](https://www.huck.psu.edu/people/claude-depamphilis) (Penn State University) to sequence genomes and epigenomes from multiple *Striga* species.
